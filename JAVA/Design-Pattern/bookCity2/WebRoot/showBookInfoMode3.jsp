...
<div class="maintop"> 
  ...
  <div class="tl"> 
	...
	<div class="zuopaihang"><span class="da d666">图书分类&nbsp;Categories</span></div> 
      ...
      <div class="tushus" id=tabap16_div_0 > 
            <div class="daod">
            	<a href="FindBookInfoByBookTypeServlet?bookTypeId=${bookType.bookTypeId}&mode=3" target="_self">${bookType.context}<br/> <span class="daox5">${bookType.bookTypeName}</span> </a> 
            </div> 
  ...
  <div class="maintopr"> 
    ...
    <a href="ChangeShowModeServlet?bookTypeId=${bType.bookTypeId}&nowPage=<%=nowPage%>&mode=2"><img src="images/liebiaoxiaotubiao.jpg" alt="图文模式" width="18" height="15" border="0"/></a> 
	<img src="images/wenzixiaotubiaoxuanzhong.jpg" alt="文章列表模式" width="18" height="15" border="0"/> 
 </td> 
    ...
    <div>
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#dadada" class="shenhui" id="li_c1">
	  <tbody><tr>
		<td width="4%" align="center">&nbsp;</td>
		<td width="31%" align="left">书名</td>
		<td width="9%" align="center">作者</td>
		<td width="19%" height="25" align="center">出版社</td>
		<td width="13%" align="center">出版时间</td>
		<td width="10%" align="center">销售价</td>
		<td width="9%" align="center">会员价</td>
		<td width="5%">&nbsp;</td>
	  </tr>
	</tbody></table>
    <div class="liebiaobian2" id="li_c2">
	  <ul>
     	<%for(BookInfo bookInfo : bookInfos){%>
     		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="shenhui">
		  <tbody><tr>
			<td width="4%" align="center">&nbsp;</td>
			<td width="31%" height="40" align="left"><a href="ShowOneBookInfoServlet?bookId=<%=bookInfo.getBookId()%>"><%=bookInfo.getBookName()%></a></td>
			<td width="9%" align="left"><a href="ShowOneBookInfoServlet?bookId=<%=bookInfo.getBookId()%>"><%=bookInfo.getAuthor()%></a></td>
			<td width="19%" align="left"><a href="ShowOneBookInfoServlet?bookId=<%=bookInfo.getBookId()%>"><%=bookInfo.getPublishName()%></a></td>
			<td width="13%" align="center"><%=bookInfo.getPublishDate()%></td>
			<td width="10%" align="center" class="huaxian">￥<%=bookInfo.getPrice()%></td>
			<td width="9%" align="center" class="hong">￥<%=bookInfo.getSpecialPrice()%></td>
			<td width="5%" align="center">            <a href="GwcServlet?opType=addBook&id=<%=bookInfo.getBookId()%>">购买</a>            </td>
		  </tr>
	  </tbody></table>
       <%} %>
	</ul>	
