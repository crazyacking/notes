			...
			if (imageGroup) {
				...
				for (TB_Counter = 0; ((TB_Counter < TB_TempArray.length) && (TB_NextHTML === "")); TB_Counter++) {
					...
					if (!(TB_TempArray[TB_Counter].href == url)) {
						...
						TB_FoundURL = true;
						TB_imageCount = "图片:第 " + (TB_Counter + 1) + " 张, 共 "
								+ (TB_TempArray.length) + " 张"
					}
				}
			}
				...
				$("#TB_window")
						.append(
								"<a href='' id='TB_ImageOff' title='Close'><img id='TB_Image' src='"
										...
										+ TB_PrevHTML
										+ TB_NextHTML
										+ "</div></div><div id='TB_closeWindow'><a href='#' id='TB_closeWindowButton' title='关闭'>&nbsp;</a></div>");
					...
					$("#TB_window")
							.append(
									"<div id='TB_title'><div id='TB_ajaxWindowTitle'>"
											+ caption
											+ "</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton' title='关闭'>&nbsp;</a></div></div><iframe frameborder='0' hspace='0' src='"
											+ urlNoQuery[0]
					...
					if (params['modal'] != "true") {
						$("#TB_window")
								.append(
										"<div id='TB_title'><div id='TB_ajaxWindowTitle'>"
												+ caption
												+ "</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton' title='关闭'>&nbsp;</a></div></div><div id='TB_ajaxContent' style='width:"
...
function show_message(url, caption) {
	try {
		if (typeof document.body.style.maxHeight === "undefined") {
			$("body", "html").css( {
				height : "100%",
		...
		TB_HEIGHT = (params['height'] * 1) + 40 || 200;
		ajaxContentW = TB_WIDTH - 30;
		ajaxContentH = TB_HEIGHT - 45;
		if ($("#TB_window").css("display") != "block") {
			$("#TB_window")
